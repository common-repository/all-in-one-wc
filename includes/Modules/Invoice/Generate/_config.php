 ...
 */
define( 'PDF_HEADER_STRING', '' ); // Pluggabl: was `"by Nicola Asuni - Tecnick.com\nwww.tcpdf.org"`
 ...
 * Path for PDF fonts
 */
if ( aiow_check_tcpdf_fonts_version( true ) ) {
	define( 'K_PATH_FONTS', aiow_get_aiow_uploads_dir( 'tcpdf_fonts' ) . '/' );
}
