<?php
/**
 * Submodule PDF Invoicing - Page Settings.
 *
 * @package WordPress
...
if ( ! class_exists( 'Page' ) ) {
	...
	/**
	 * Declare class `Page` extends to `\AIOW\Modules\Register_Modules`.
	 */
	class Page extends \AIOW\Modules\Register_Modules {
		...
		function __construct() {
			...
			$this->short_desc = __( 'Page Settings', 'all-in-one-wc' );
			$this->desc       = '';
